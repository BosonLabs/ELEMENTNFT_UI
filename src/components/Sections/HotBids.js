...
const HotBids = () => {
  ...
  console.log("getApiFullHotBids",getApiDataNftFull)        
  // React.useEffect(() => {
    //     window.scrollTo(0, 0);     
    // });
    // React.useEffect(() => {
            ...
            >
                ...
                return(  
                    ...
                    <div className='carousel-cell carousel-cell-20'>
                      <CardHotbids HistoryAddress={x.nftHistoryAddresses} pAddress={x.previousOwner} oAddress={x.ownerAddress} verify={true} img={x.nftImageAsString} title={x.nftName} count="401" subTitle={`<span>Highest bid</span> <span>${x.nftPrice/1000000}</span>`} linkText="0.221 WETH" dataall={x} Assetid={x.assetId}/>
                    </div>
                    {/* </div>                    
                    </div> */}
                    </>                                                                                          
