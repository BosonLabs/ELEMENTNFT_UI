...
const Explore = () => {
  ...
  console.log("getApiFullExplore",getApiDataNftFull)        
    // React.useEffect(() => {
    // window.scrollTo(0, 0);     
    // });
    ...
    const filterdata=()=>{
      ...
      if(getrecent ===  "High to Low"){
        let data=getApiDataNftFull.sort((a,b)=>{ return parseInt(b.nftPrice/1000000) - parseInt(a.nftPrice/1000000)})
        //console.log("filtercall1",data)
        return data;
      }
      
      return getApiDataNftFull
    }
    return (
        <div className='mb-36'>
