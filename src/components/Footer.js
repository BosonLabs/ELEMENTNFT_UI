...
import {Container, Row, Col, Form, InputGroup, Button, Badge, Dropdown,Modal} from 'react-bootstrap';
import {
    Link,useHistory
...
import CertifiedImage from '../assets/images/certified-image.png';
import fireDb from '../firebase';

function Footer() {
    let history=useHistory();
    const [getMail,setMail]=React.useState(null);
    const [Done,setDone]=React.useState(false);
    const handleCloseTest = () => setDone(false);
    ...
    return (
        ...
        //                             <Dropdown>
        //                                 <Dropdown.Toggle variant="outline-gray" className='w-100 justify-content-between'>
        //                                     English
        //                                 </Dropdown.Toggle>
        ...
        //             <Button variant="primary" size="lg" className='w-100' onClick={()=>doneRefresh()}>Done</Button>
        //         </Modal.Body>
        //     </Modal>
        // </div>
        <div className="footer">
        <Container>
            ...
            <div className="copyrights d-flex flex-md-row flex-column align-items-center justify-content-between">
                ...
                <p>© BOSON LABS, Inc. All rights reserved.</p>
            </div>                
        </Container>
        {/* onHide={handleCloseTest} */}
        <Modal show={Done} centered size="sm" >
