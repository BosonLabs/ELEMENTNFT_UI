        ...
        <>
            ...
            <header className="header">
                <Container fluid className="d-flex align-items-center">
                    <div className="logo">                                                
                        {/* <a href={"https://elementdefi.vercel.app/"} target="_blank" rel="noopener noreferrer" className='d-flex align-items-center'> */}
                            ...
                            <h3 className='m-0'>&nbsp;&nbsp;ELEMENT</h3>
                        {/* </a> */}
                        </Link>
                    </div>

                    <Form className='flex-grow-1 position-relative d-xl-block d-none'>
                        <InputGroup className='input-group-search'>
                            ...
                            <Form.Control value={searchText} onChange={(e) => setSearchText(e.target.value)} placeholder="Collection or item" />
                        </InputGroup>
                        {searchText && (
                            <>
                        ...
                        <div className="header-search-header align-items-center d-flex">
                            ...
                            <Form className='flex-grow-1'>
                                <InputGroup className='input-group-search'>
                                    ...
                                    <Form.Control placeholder="Collection or item " />
                                </InputGroup>
                            </Form>
                        </div>
