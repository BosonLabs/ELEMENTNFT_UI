        ...
        <Card>
            <Card.Header className='d-flex align-items-center'>
                ...
                <Dropdown className='dropdown-noarrow'>
                    ...
                    }}><Dropdown.Item href="/bid">Buy now</Dropdown.Item>
                    </Link>
                        <Dropdown.Divider />
                    ...
                    {props.timer ? (
                        <div className="timer">
                            <div>
                                {/* {props.timer}  */}
                            <span>left</span>
                            <img src="https://cdn.jsdelivr.net/npm/emoji-datasource-apple@6.0.1/img/apple/64/1f525.png" alt="fire" />
                            </div>
                            </div>
                    ) : null}
                </div>
