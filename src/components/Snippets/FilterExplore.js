...
const FilterExplore = ({setMax,setMin,setChain,setCategory,setRecent,setSaletype,getrecent}) => {
    ...
    //const [gethain,sethain]=useState(blockChainOptions[0]);
    //console.log("ppgethain",gethain.value)
    const colourStyles = {
            ...
            <div className="filter-dropdown ms-auto">
                <Dropdown className='dropdown-noarrow'>
                    ...
                    <Dropdown.Menu className='dropdown-menu-right link-flex'>
                        ...
                        <Dropdown.Item onClick={event => setRecent("Recently added")}>
                            Recently added
                        ...
                        <Dropdown.Item onClick={event => setRecent("Low to High")}>
                            Price: Low to High
                        </Dropdown.Item>
